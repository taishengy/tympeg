...
# TODO: Print list of invalid files
...
class Window(QDialog):
    ...
    def __init__(self):
        ...
        defaultDirectory = "T:\Video\Anime and TV"
    ...
    def saveLog(self):
        ...
        with open("ConversionLog" + str(time.strftime("%Y%m%d")) + ".txt", 'w') as logFile:
    ...
    def analyze(self):
        ...
        for dirs in directoryList:
            ...
            for fileNames in os.listdir(rootdir + dirs):
                filePath = rootdir + dirs + "\\" + fileNames
